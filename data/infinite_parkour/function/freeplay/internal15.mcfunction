...
execute if score py math >= by math run function infinite_parkour:freeplay/internal16
execute if score py math >= by math run return 0
execute if data entity @s {OnGround:1b} run function infinite_parkour:freeplay/internal17
execute if data entity @s {OnGround:1b} run return 0
execute if entity @s[tag=!ParkourFalling] run function infinite_parkour:freeplay/internal18
...
execute as @e[tag=ip_block_marker,distance=..512] at @s run function infinite_parkour:freeplay/internal19
