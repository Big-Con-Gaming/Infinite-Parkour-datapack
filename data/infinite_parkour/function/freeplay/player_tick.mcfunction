...
execute positioned ~-0.85 ~-1 ~-0.85 as @e[type=marker,tag=ip_block_platform,tag=!ip_block_reached,tag=!ip_jump_next,dx=0.7,dy=0,dz=0.7] at @s run function infinite_parkour:freeplay/internal12
