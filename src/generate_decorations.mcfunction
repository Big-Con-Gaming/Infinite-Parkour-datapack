...
execute if score RandoDeco RandomNum matches 4 at @n[type=marker,tag=ParkourNextJump] run
...
schedule function infinite_parkour:delayed_deco_interpolations 4t
