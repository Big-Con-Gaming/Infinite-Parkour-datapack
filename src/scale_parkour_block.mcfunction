...
execute as @e[type=marker,tag=ParkourGoal] at @s run
...
/apply
  ...
  $data merge entity @s[tag=ParkourGeneratedDisplay] {start_interpolation:0,transformation:{scale:[$(s)f,$(s)f,$(s)f],translation:[-$(s2)f,-$(s2)f,-$(s2)f]}}
  $data merge entity @s[tag=ParkourPrevDisplay] {start_interpolation:0,transformation:{scale:[$(d)f,$(d)f,$(d)f],translation:[-$(d2)f,-$(d2)f,-$(d2)f]}}