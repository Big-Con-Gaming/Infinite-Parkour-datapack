...
/apply
  ...
  $data merge entity @n[type=block_display,distance=..10,tag=ParkourGeneratedDisplay] {transformation:{scale:[$(s)f,$(s)f,$(s)f],translation:[-$(s2)f,-$(s2)f,-$(s2)f]}}
  $data merge entity @n[type=block_display,distance=..10,tag=ParkourPrevDisplay] {transformation:{scale:[$(d)f,$(d)f,$(d)f],translation:[-$(d2)f,-$(d2)f,-$(d2)f]}}