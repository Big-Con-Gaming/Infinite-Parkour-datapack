...
execute as @a[team=ParkourPlayers] at @s
  ...
  execute align xyz positioned ~-10 ~-10 ~-1 unless entity @e[type=marker,tag=ParkourEndLobby,dx=20,dy=20,dz=20] if dimension infinite_parkour:infinite_parkour run fill ~50 ~50 ~-1 ~-50 ~-50 ~-1 air
